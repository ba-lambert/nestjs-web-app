...
export class NewMigrations1712525456668 implements MigrationInterface {
    name = 'NewMigrations1712525456668'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`profile\` (\`id\` varchar(36) NOT NULL, \`fullnames\` varchar(255) NOT NULL, \`email\` varchar(255) NOT NULL, \`phoneNo\` int NOT NULL, \`authId\` varchar(36) NULL, UNIQUE INDEX \`REL_9e51479f7c74c1c61637515b04\` (\`authId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
