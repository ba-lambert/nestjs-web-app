...
export class NewMigrations1712610153277 implements MigrationInterface {
    name = 'NewMigrations1712610153277'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`post\` (\`postId\` varchar(36) NOT NULL, \`author\` varchar(255) NOT NULL, \`header\` varchar(255) NOT NULL, \`content\` varchar(255) NOT NULL, \`likesId\` varchar(36) NULL, \`commentsId\` varchar(36) NULL, PRIMARY KEY (\`postId\`)) ENGINE=InnoDB`);
