...
export class NewMigrations1712953173534 implements MigrationInterface {
    name = 'NewMigrations1712953173534'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`likes\` (\`id\` varchar(36) NOT NULL, \`likes\` int NOT NULL, \`authId\` varchar(36) NULL, \`postPostId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`likes\` ADD CONSTRAINT \`FK_f6577e0f10bd794973cfc02544f\` FOREIGN KEY (\`postPostId\`) REFERENCES \`post\`(\`postId\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
